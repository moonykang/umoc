...
namespace renderer
{
Result GridLayerPass::init(platform::Context* platformContext, scene::SceneInfo* sceneInfo)
{
...
void GridLayerPass::terminate(platform::Context* context)
{
    TERMINATE(object, context);
}

Result GridLayerPass::render(platform::Context* platformContext, scene::SceneInfo* sceneInfo)
{
    rhi::Context* context = platformContext->getRHI();
