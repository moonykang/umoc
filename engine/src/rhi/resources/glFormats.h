...
Internal format to glTexImage2D, glTexImage3D, glCompressedTexImage2D, glCompressedTexImage3D, glTexStorage2D,
glTexStorage3D
...
static inline void glGetFormatSize(const GLenum internalFormat, GlFormatSize* pFormatSize)
{
    ...
    case GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT: // line through 3D space plus 1-bit alpha, 4x4 blocks, sRGB
        ...
        pFormatSize->blockDepth = 1;
        break;
    case GL_COMPRESSED_RGBA_S3TC_DXT5_EXT: // line through 3D space plus line through 1D space, 4x4 blocks, unsigned
                                           // normalized
